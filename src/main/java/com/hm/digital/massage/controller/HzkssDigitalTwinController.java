...
public class HzkssDigitalTwinController extends BaseController<MqRollCallMapper, MqRollCall> {
  ...
  public void trigger(@RequestBody MqRollCall mqRol) {
    ...
    rabbitTemplate.convertAndSend(RabbitMqEnum.ROLL_CALL_BEGINS.getExchange(),RabbitMqEnum.ROLL_CALL_BEGINS.getRoutingKey(), JSONObject.toJSONString(mqRol));
  }
  ...
  public void personPosition(@RequestBody MqRollCall mqRol) {
    ...
    rabbitTemplate.convertAndSend(RabbitMqEnum.ROLL_CALL_CREDIT_CARD.getExchange(),RabbitMqEnum.ROLL_CALL_CREDIT_CARD.getRoutingKey(), JSONObject.toJSONString(mqRol));
  }
